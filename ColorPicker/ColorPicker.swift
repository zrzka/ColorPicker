...
extension Comparable {
  mutating func clamp(minimum: Self, _ maximum: Self) {
...
class ColorPicker: UIView {
  ...
  private func setup() {
    ...
    wheel.didChangeWheelColor = { [weak self] color in
      ...
      self?.color = UIColor(hue: color.0 / 360.0, saturation: color.1, brightness: color.2, alpha: CGFloat(1.0))
    }
  }
